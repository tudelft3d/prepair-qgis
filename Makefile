...
# translation
SOURCES = prepair.py ui_prepair.py __init__.py prepairdialog.py
#TRANSLATIONS = i18n/prepair_en.ts
TRANSLATIONS =
...
PY_FILES = prepair.py prepairdialog.py __init__.py

EXTRAS = icon.png metadata.txt

UI_FILES = ui_prepair.py
